                           ...
                           float quantity)
{
  ...
  FMOD_System_CreateDSPByType(system, FMOD_DSP_TYPE_DISTORTION, &distortion);
...
FMOD_DSP* flange_event(FMOD_SYSTEM* system,FMOD_DSP* flange)
{
  ...
  {
    FMOD_System_CreateDSPByType(system, FMOD_DSP_TYPE_FLANGE, &flange);
...
FMOD_DSP* low_pass_event(FMOD_SYSTEM* system,FMOD_DSP* low_pass) 
{
  ...
  {
    FMOD_System_CreateDSPByType(system, FMOD_DSP_TYPE_LOWPASS, &low_pass);
...
FMOD_DSP* high_pass_event(FMOD_SYSTEM* system,FMOD_DSP* high_pass) 
{
  ...
  {
    FMOD_System_CreateDSPByType(system, FMOD_DSP_TYPE_HIGHPASS, &high_pass);
...
FMOD_DSP* egaliseur (FMOD_SYSTEM* system, FMOD_DSP* dsp, 
                    float center, float gain)
{
  FMOD_DSP_Remove(dsp);
